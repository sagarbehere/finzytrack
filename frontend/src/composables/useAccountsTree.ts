...
interface UseAccountsTreeReturn {
  ...
  // Actions
  buildTree: (accounts: AccountDetails[]) => AccountTreeNode[]
  flattenForDisplay: (roots: AccountTreeNode[], expandedIds: Set<string>) => AccountTreeNode[]
  filterTree: (nodes: AccountTreeNode[], filters: AccountFilters) => AccountTreeNode[]
 ...
 */
function flattenForDisplay(roots: AccountTreeNode[], expandedIds: Set<string>): AccountTreeNode[] {
 ...
 */
function filterTree(nodes: AccountTreeNode[], filters: AccountFilters): AccountTreeNode[] {
