  ...
  <div class="w-full">
    ...
    <div class="mb-4">
      ...
      <div v-else-if="availableRules.length === 0" class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4 text-sm text-yellow-800 dark:text-yellow-200">
        No CSV rules found. <a href="https://finzytrack.app/docs/csv-rules" target="_blank" rel="noopener noreferrer" class="underline underline-offset-2 hover:text-yellow-900 dark:hover:text-yellow-100">Learn how to create CSV rule files</a>.
      </div>
