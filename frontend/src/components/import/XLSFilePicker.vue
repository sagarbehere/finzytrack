  ...
  <div class="w-full">
    ...
    >
      ...
      <div v-if="!selectedFile">
        ...
        <div class="mt-4">
          <h3 class="text-lg font-medium text-gray-900 dark:text-white">Upload XLS File</h3>
          <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Drop your XLS or XLSX file here or
            <button
    ...
    <div v-if="selectedFile" class="mt-6">
      <FormFeedback
        ...
        :message="parseError"
        severity="error"
        details="Please ensure you selected a valid XLS/XLSX file and the correct rule."
        class="mb-4"
      />
