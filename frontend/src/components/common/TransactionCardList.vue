        ...
        <div class="divide-y divide-gray-100 dark:divide-white/5">
          ...
          <div v-if="isColumnVisible('date')" class="flex items-center justify-between px-4 py-2">
            ...
            <input
              ...
              @change="(e) => emit('updateField', transaction.id, 'date', (e.target as HTMLInputElement).value)"
          ...
          <div v-if="isColumnVisible('payee')" class="px-4 py-2">
            ...
            <input
              ...
              @change="(e) => emit('updateField', transaction.id, 'payee', (e.target as HTMLInputElement).value)"
              placeholder="Payee"
              :class="inputClasses()"
              autocomplete="off"
            />
          ...
          <div v-if="isColumnVisible('memo')" class="px-4 py-2">
            ...
            <input
              ...
              @change="(e) => emit('updateField', transaction.id, 'memo', (e.target as HTMLInputElement).value)"
              placeholder="Memo"
              :class="inputClasses()"
              autocomplete="off"
            />
          ...
          <div v-if="isColumnVisible('narration')" class="px-4 py-2">
            ...
            <input
              ...
              @change="(e) => emit('updateField', transaction.id, 'narration', (e.target as HTMLInputElement).value)"
          ...
          <div v-if="isColumnVisible('tags_links')" class="px-4 py-2">
            ...
            <input
              ...
              @change="(e) => emit('updateField', transaction.id, 'tags_links', (e.target as HTMLInputElement).value)"
          ...
          <div class="divide-y divide-gray-100 dark:divide-white/5">
            ...
            <div v-if="isColumnVisible('cost_date')" class="flex items-center justify-between px-4 py-2">
              ...
              <input
                ...
                @change="(e) => emit('updateField', transaction.id, `postings.${idx}.cost.date`, (e.target as HTMLInputElement).value)"
                :class="inputClasses('text-right max-w-[10rem]')"
                autocomplete="off"
              />
