...
# Compute errors (/api/compute — the server-side function registry)
...
# Budget errors (/api/budgets — custom "budget" directive CRUD)
BUDGET_NOT_FOUND = "BUDGET_NOT_FOUND"
BUDGET_VALIDATION_ERROR = "BUDGET_VALIDATION_ERROR"

# Price-fetch errors (/api/prices/update — the sidecar price fetcher)
PRICE_UPDATE_FAILED = "PRICE_UPDATE_FAILED"

# Dashboard theme errors (/api/dashboard-theme — chart/widget color themes)
DASHBOARD_THEME_NOT_FOUND = "DASHBOARD_THEME_NOT_FOUND"
DASHBOARD_THEME_VALIDATION_ERROR = "DASHBOARD_THEME_VALIDATION_ERROR"

# Startup-task errors (/api/startup — upgrade/notice tasks)
STARTUP_TASK_NOT_FOUND = "STARTUP_TASK_NOT_FOUND"
