...
from app.config import EmailServiceConfig
from app.core.imap_client import fetch_emails
from app.core.rule_registry import AccountProfileRegistry
from app.core.regex_extractor import ExtractionError
from app.core.llm_extractor import LLMExtractionError
from app.schemas.result_schemas import (
    FetchResult, FetchStats, ParsedTransaction,
    UnmatchedEmail, ExtractionError as ExtractionErrorSchema,
    ProgressEvent,
)
    ...
    try:
        ...
        for i, raw in enumerate(raw_emails, start=1):
            ...
            try:
                ...
                extraction_errors.append(ExtractionErrorSchema(
                    from_address=raw.from_address,
                    subject=raw.subject,
                    date=raw.date,
