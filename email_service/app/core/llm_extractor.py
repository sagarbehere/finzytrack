...
def extract_fields_llm(
    ...
    if explicit_sign_rule:
        ...
        # field-based sign rule would need the extracted transaction_type value —
        # handled in fetch_service.py where we have access to all extracted fields
    ...
    if is_debit is True:
        ...
        amount = abs(amount)
    # if is_debit is None/missing, leave amount as positive (caller can handle)
